...
async def get_correlations(
    ...
    try:
        ...
        filtered   = _filter(_load_responses_cached(), business, year, country, department, include_inactive) if use_cohort else []
...
async def get_insights(
    ...
    try:
        business    = _resolve_business(user, business)
        questions   = _read("questions.json")
        filtered    = _filter(_load_responses_cached(), business, year, country, department)
