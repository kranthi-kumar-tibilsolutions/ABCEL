    ...
    <div className="page-container">
      ...
      <div className="sa-grid-3">
        ...
        <div className="sa-card">
          <div className="sa-card-title" style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            Overall Sentiment Score
            <InfoTip tip="Composite sentiment score from -1 (very negative) to +1 (very positive), derived from NLP analysis of all open-text survey responses." />
          </div>
        ...
        <div className="sa-card">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
            <div className="sa-card-title" style={{ marginBottom: 0, display: 'flex', alignItems: 'center', gap: 6 }}>
              Sentiment Distribution
              <InfoTip tip="Breakdown of all responses into Positive, Neutral, and Negative buckets. Click a bucket to filter the topic breakdown and sample quotes below." />
            </div>
            {activeSentiment && (
        ...
        <div className="sa-card" style={{ display: 'flex', flexDirection: 'column' }}>
          <div className="sa-card-title" style={{ marginBottom: 8, display: 'flex', alignItems: 'center', gap: 6 }}>
            Sentiment Over Time
            <InfoTip tip="Year-over-year sentiment trend across survey waves. Each data point is the average sentiment score for that quarter." />
          </div>
          <TwinTrendChart />
      ...
      <div className="sa-grid-3">
        ...
        <div className="sa-card" style={{ padding: compact ? '10px 12px' : undefined }}>
          <div className="sa-card-title" style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <InfoTip tip="Most frequently mentioned themes in open-text responses. Word size reflects mention frequency; colour indicates overall sentiment for that theme." />
          </div>
        ...
        <div className="sa-card" style={{ padding: compact ? '10px 10px' : '14px 12px' }}>
          <div className="sa-card-title" style={{ marginBottom: 8, display: 'flex', alignItems: 'center', gap: 6 }}>
            Topic Sentiment Breakdown
            <InfoTip tip="Per-topic sentiment score (-1 to +1) and share of total responses. Use the distribution filter above to narrow to a specific sentiment." />
            {activeSentiment && (
              <span style={{
        ...
        <div className="sa-card" style={{ padding: compact ? '10px 10px' : '14px 12px' }}>
          <div className="sa-card-title" style={{ marginBottom: compact ? 2 : 3, fontSize: 11, display: 'flex', alignItems: 'center', gap: 6 }}>
            Sentiments Validate Statistical Findings
            <InfoTip tip="Cross-validates open-text sentiment themes against quantitative driver correlations — showing whether what employees write aligns with what the numbers say." />
          </div>
      ...
      <div className="sa-card">
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
          <div className="sa-card-title" style={{ marginBottom: 0, display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <InfoTip tip="Representative verbatim quotes from employees, grouped by sentiment. Click a sentiment bucket in the distribution card above to filter." />
          </div>
          {activeSentiment && (
            <span style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 10.5, color: 'var(--text-muted)', paddingBottom: 4 }}>
        <InfoTip tip="NLP models may not capture sarcasm, idioms, or cultural nuance in all responses. Review raw quotes before drawing conclusions." />
