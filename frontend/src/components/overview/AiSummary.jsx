        ...
        <>
          ...
          <div className="ais-grid" style={{
            ...
            <div className="ais-col-left">
              ...
              <div>
                <div className="ais-title" style={{ display: 'flex', alignItems: 'center' }}>
                  AI EXECUTIVE SUMMARY
                  <InfoTip text="Generated by AI from the current survey wave. Summarises key engagement findings, top drivers, and a recommended action for HR." />
                </div>
