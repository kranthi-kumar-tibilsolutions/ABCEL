      ...
      <div className="section-header">
        <div>
          <h3 className="cluster-section-title">
            ...
            <InfoTip text="BUs are clustered by overall engagement score and score variance: Thriving (high score, low variance), At Risk (low score, low variance), Polarised (high variance, strong core), Critical (low score, high variance)." />
          </h3>
